...
function ycoordinates(imagename){
	if (imagename.indexOf("0phase") > -1) return padding*(0+manualrows);
	else if (imagename.indexOf("1phase") > -1) return padding*(1+manualrows);
	else if (imagename.indexOf("2phase") > -1) return padding*(2+manualrows);
	else if (imagename.indexOf("3phase") > -1) return padding*(3+manualrows);
	else if (imagename.indexOf("4phase") > -1) return padding*(4+manualrows);
	else if (imagename.indexOf("5phase") > -1) return padding*(5+manualrows);
	else if (imagename.indexOf("6phase") > -1) return padding*(6+manualrows);
	else{
...
if (badges_array.length>0){
	...
	$('#message').text('Please choose an inquiry to see your badges (top-right corner)');
}		
