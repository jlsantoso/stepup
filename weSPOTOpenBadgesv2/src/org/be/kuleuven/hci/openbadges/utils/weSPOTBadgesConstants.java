...
public class weSPOTBadgesConstants {
	...
	public static final String CONTRIBUTIONS_1_LEVEL = "10";
	public static final String CONTRIBUTIONS_2_LEVEL = "10";
	public static final String CONTRIBUTIONS_3_LEVEL = "5";
	...
	public static final String BADGE_CRITERIA_LEVEL2 = PEERS_CONTRIBUTIONS+" peers have to react to your contributions: Commenting, rating, liking, etc (number of reactions 10)";
