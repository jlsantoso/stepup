...
public class PeriodicBadgesServlet extends HttpServlet {
	
	private static final Logger log = Logger.getLogger(PeriodicBadgesServlet.class.getName());
	
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		ChiCourseBadgesRules.tweets();
		ChiCourseBadgesRules.commentsOnOtherBlogs(8);
		ChiCourseBadgesRules.commentsOnOwnBlogs();
		ChiCourseBadgesRules.diigo();
		ChiCourseBadgesRulesLinks.numberLinks();
		ChiCourseBadgesRulesQATweets.qatweets();
		ChiCourseBadgesRulesFaster.fasterInPostAfterLesson();
		ChiCourseBadgesRulesFaster.fasterInGetACommentAfterLesson();
