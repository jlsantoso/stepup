...
public class ReadGoogleSpreadSheetMume13 {
	...
	public static void read() {
	    ...
	    try {
	      ...
	      String urlString = "https://spreadsheets.google.com/feeds/list/0AlKgYvYnImYIdFpLRVgyRUVKSWpxVjQxcUFxN2NfWVE/default/public/values";
	      ...
	      syncCache.put("urlsBlogsMume13", urlsBlogs);
	    } catch (IOException e) {
	      e.printStackTrace();
