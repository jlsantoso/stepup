...
public class ReadGoogleSpreadSheetThesis13 {
	...
	public static void read() {
	    ...
	    try {
	      ...
	      String urlString = "https://spreadsheets.google.com/feeds/list/0AlKgYvYnImYIdHBJX1lOS2NqSm5PT1RrdFdSMUpZUlE/default/public/values";
	      ...
	      for (ListEntry entry : feed.getEntries()) {
	    	//if (checkingCells(entry)){	    	
		        ...
		        String wordpresspostrssfeed = elements.getValue("wprss").toLowerCase();
		        blogsfeeds.put(wordpresspostrssfeed, groupname);
		        String wordpresscommentrssfeed = elements.getValue("wcommentsrss").toLowerCase();
	      ...
	      syncCache.put("urlsBlogsThesis13", urlsBlogs);
	    } catch (IOException e) {
	      e.printStackTrace();
